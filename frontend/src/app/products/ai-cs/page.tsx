...
import { AiCsPayment } from "@/components/sections/products/aics/AiCsPayment";
...
export const metadata: Metadata = {
  ...
  description:
    "Automate your customer service and scale sales with a 24/7 AI-driven intelligent text agent.",
};
